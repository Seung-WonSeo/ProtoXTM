...
def main():
    ...
    # topic_file = "/workspace/ProtoXTM/results/Amazon_Review/topic_en_10.txt"
    # topic_file = "/workspace/InfoCTM/topic_en_20.txt"
    topic_file = "/workspace/topic_en.txt"
...
def main():
    ...
    # topic_file = "/workspace/ProtoXTM/results/Amazon_Review/topic_cn_10.txt"
    # topic_file = "/workspace/Overall_Results/InfoCTM/AR_topic_cn_20.txt"
    topic_file = "/workspace/topic_cn.txt"
